...
const works = [
  {
    name: "THE MODEST PUPPETRY FESTIVAL 3: ELECTRIC BOOGALOO",
    date: "July, 2025",
  ...
  {
    name: "WHAT IT DOES TO US",
    date: "July 2025",
    description: "feltboard show",
    location: "Charlottesville, VA",
    duration: "12 minutes",
    synopsis:
  ...
  {
    name: "THE NETTLE SHIRTS",
    date: "February 2025",
    description: "Shadow puppetry with live shadow actors",
...
const index = () => {
  return (
    <Container>
      <Box>
        <Typography variant="h1" sx={{ margin: "1em 0", textAlign: "center" }}>
          Works
        </Typography>
            ...
            return (
              <>
                <Grid key={index} item xs={12} md={7}>
                  ...
                  >
                    <Box>
                      <Typography>{`${work.location}, ${work.date} ${
                        work.duration && "-"
                      } ${work.duration}`}</Typography>
                      ...
                      <Typography>{work.synopsis}</Typography>
                      {work.link && (
                        <>
                          <br />
                          <Link href={work.link}>
